  ...
  return (
    <Container>
      ...
      {searchTermLength.length > 20 ? (
        ...
        <p className={classes.searchTermLength}>{searchTermLength} registers found</p>
      )}
            ...
            <Grid item xs={12} sm={6} md={4} lg={3}>
              ...
              <Card className={classes.root} variant="outlined">
                <CardContent>
                  ...
                  <div
                    style={{
                      height: imgNums.find(idd => idd == questionn.Id) ? '100px' : '0',
                      width: "100px",
                      backgroundImage: `url(./img/${questionn.Id}.png)`,
                    }}
                  >
